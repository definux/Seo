...
namespace Definux.Seo.Models
{
    ...
    public class MetaTagsModel
    {
        ...
        {
            this.Title.Value = title + this.TitleSuffix;
            this.OpenGraphTitle.Value = title + this.TitleSuffix;
            this.TwitterTitle.Value = title + this.TitleSuffix;
        }
